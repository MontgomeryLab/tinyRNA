...
from tinyrna.srna.Configuration import timestamp_format
from tinyrna.srna.plotterlib import plotterlib as lib
...
def get_args():
    ...
    parser.add_argument('-s', '--style-sheet', metavar='MPLSTYLE',
                        default=resource_filename('tinyrna', 'extras/tinyrna-light.mplstyle'),
