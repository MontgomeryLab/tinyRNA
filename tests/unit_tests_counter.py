...
import tiny.srna.counter.counter as counter
from tiny.srna.counter.hts_parsing import Alignment, read_SAM
from tiny.srna.util import from_here
...
class CounterTests(unittest.TestCase):
    ...
    def test_load_samples_single(self):
        ...
        with patch('tiny.srna.counter.counter.open', mock_open(read_data=csv)):
